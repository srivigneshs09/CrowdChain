...
const Sidebar = () => {
  ...
  return (
    <div className="flex justify-between items-center flex-col sticky top-5 h-[93vh]">
      <Link to="/">
        <Icon styles="w-[130px] h-[150px] -ml-7 -mt-10" imgUrl={logo1} />
      </Link>

      <div className="flex-1 flex flex-col justify-between items-center bg-[#ffffff] rounded-[20px] w-[76px] py-4 mt-12 -ml-7 shadow-secondary">
        ...
        <Icon styles="bg-[#ffffff] " imgUrl={sun} />
      </div>
    </div>
  )
}
